    ...
    public function test_checkout_redirects_to_cart_when_saved_coupon_exceeds_maximum(): void
    {
        ...
        try {
            ...
            $response->assertRedirect(route('cart'))
                ->assertSessionHas('coupon_error', 'الكوبون ده متاح لحد قيمة سلة 2,000.00 EGP بس. قيمة سلتك الحالية 3,000.00 EGP.')
            ...
            $cartPage->assertOk()
                ...
                ->assertSee('GAME_CHANGER')
                ->assertSee('الكوبون ده متاح لحد قيمة سلة 2,000.00 EGP بس. قيمة سلتك الحالية 3,000.00 EGP.');
        } finally {
            DB::table('coupons')->where('code', 'GAME_CHANGER')->delete();
    ...
    public function test_cart_update_invalidates_coupon_when_subtotal_exceeds_maximum(): void
    {
        ...
        try {
            ...
            $cartPage->assertOk()
                ...
                ->assertSee('rememberCartRequestPosition', false)
                ->assertSee('restoreCartRequestPosition', false)
                ->assertSee('ramo_cart_request_position', false)
