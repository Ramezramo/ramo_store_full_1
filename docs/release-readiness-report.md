...
| Automated regression suite | `php artisan test` passed **105 tests and 476 assertions** after the password-reset endpoint remediation on 14 August 2026. | **Passed for covered behavior.** |
