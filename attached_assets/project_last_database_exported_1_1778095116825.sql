...
\restrict co74m7aNMBTajuueed5c7uyGhlegS2j5mudQ9ufFhrJeGba298Jzvf0KyPY3dPe
...
CREATE TABLE public.order_messages (
    ...
    updated_at timestamp(0) without time zone,
    sub_order_id bigint,
    CONSTRAINT order_messages_sender_type_check CHECK (((sender_type)::text = ANY ((ARRAY['customer'::character varying, 'vendor'::character varying])::text[])))
);
...
\unrestrict co74m7aNMBTajuueed5c7uyGhlegS2j5mudQ9ufFhrJeGba298Jzvf0KyPY3dPe
