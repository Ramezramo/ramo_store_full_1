...
@section('page-title', 'Auth Settings')
...
<div class="settings-grid">
  ...
  <div class="setting-section">
    ...
    <div class="toggle-row">
      ...
      <label class="toggle-switch"><input type="checkbox" name="email_login" {{ ($config['email_login'] ?? true) ? 'checked' : '' }}><span class="toggle-slider"></span></label>
    </div>

    <div class="toggle-row">
      <div><div class="toggle-label">Google Login</div><div class="toggle-sub">OAuth via Google account</div></div>
      <label class="toggle-switch"><input type="checkbox" name="google_login" {{ ($config['google_login'] ?? false) ? 'checked' : '' }}><span class="toggle-slider"></span></label>
    </div>

    <div class="toggle-row">
      <div><div class="toggle-label">Phone OTP</div><div class="toggle-sub">SMS one-time password login</div></div>
      <label class="toggle-switch"><input type="checkbox" name="phone_otp_login" {{ ($config['phone_otp_login'] ?? false) ? 'checked' : '' }}><span class="toggle-slider"></span></label>
    </div>
  ...
  <div class="setting-section">
    ...
    <div class="toggle-row">
      ...
      <label class="toggle-switch"><input type="checkbox" name="guest_checkout" {{ ($config['guest_checkout'] ?? false) ? 'checked' : '' }}><span class="toggle-slider"></span></label>
    </div>
  </div>
  ...
  <div class="setting-section">
    ...
    <div class="toggle-row">
      ...
      <label class="toggle-switch"><input type="checkbox" name="auto_register_google" {{ ($config['auto_register_google'] ?? true) ? 'checked' : '' }}><span class="toggle-slider"></span></label>
    </div>

    <div class="toggle-row">
      <div><div class="toggle-label">Auto-register via OTP</div><div class="toggle-sub">Create account on first OTP verify</div></div>
      <label class="toggle-switch"><input type="checkbox" name="auto_register_otp" {{ ($config['auto_register_otp'] ?? true) ? 'checked' : '' }}><span class="toggle-slider"></span></label>
    </div>

    <div class="toggle-row">
      <div><div class="toggle-label">Require Name</div><div class="toggle-sub">Name field mandatory on signup</div></div>
      <label class="toggle-switch"><input type="checkbox" name="require_name_on_register" {{ ($config['require_name_on_register'] ?? true) ? 'checked' : '' }}><span class="toggle-slider"></span></label>
    </div>
  ...
  <div class="setting-section">
    ...
    <div class="num-row"><div><div class="toggle-label">OTP Length</div><div class="toggle-sub">Number of digits (4–8)</div></div><input type="number" name="otp_length" class="num-input" min="4" max="8" value="{{ $config['otp_length'] ?? 6 }}"></div>
    <div class="num-row"><div><div class="toggle-label">OTP Expiry</div><div class="toggle-sub">Minutes before code expires</div></div><input type="number" name="otp_expiry_minutes" class="num-input" min="1" max="30" value="{{ $config['otp_expiry_minutes'] ?? 5 }}"></div>
    <div class="num-row"><div><div class="toggle-label">Max Attempts</div><div class="toggle-sub">Wrong guesses before block</div></div><input type="number" name="max_otp_attempts" class="num-input" min="1" max="10" value="{{ $config['max_otp_attempts'] ?? 3 }}"></div>
    <div class="num-row"><div><div class="toggle-label">Resend Cooldown</div><div class="toggle-sub">Seconds between resend requests</div></div><input type="number" name="resend_cooldown_seconds" class="num-input" min="10" max="300" value="{{ $config['resend_cooldown_seconds'] ?? 60 }}"></div>
    <div class="num-row"><div><div class="toggle-label">Max Resends/Hour</div><div class="toggle-sub">OTP requests per phone per hour</div></div><input type="number" name="max_resends_per_hour" class="num-input" min="1" max="20" value="{{ $config['max_resends_per_hour'] ?? 3 }}"></div>
  </div>
  ...
  <div class="setting-section">
    ...
    <div class="num-row"><div><div class="toggle-label">Max Login Attempts</div><div class="toggle-sub">Before account lockout</div></div><input type="number" name="max_login_attempts" class="num-input" min="1" max="20" value="{{ $config['max_login_attempts'] ?? 5 }}"></div>
    <div class="num-row"><div><div class="toggle-label">Lockout Duration</div><div class="toggle-sub">Minutes account stays locked</div></div><input type="number" name="lockout_duration_minutes" class="num-input" min="1" max="1440" value="{{ $config['lockout_duration_minutes'] ?? 15 }}"></div>
    <div class="num-row"><div><div class="toggle-label">Session Expiry</div><div class="toggle-sub">Hours before auto-logout</div></div><input type="number" name="session_expiry_hours" class="num-input" min="1" max="720" value="{{ $config['session_expiry_hours'] ?? 24 }}"></div>
  </div>
