...
function buildEditor(sec, idx) {
  ...
  if (type === 'logo') {
    ...
    html = `<div class="form-grid">
      ...
      <div class="form-group"><label>Element Spacing (px)</label><input type="number" value="${sec.elementSpacing!=null?sec.elementSpacing:0}" min="0" max="15" step="1" onchange="updateField(${idx},'elementSpacing',Math.max(0,Math.min(15,parseInt(this.value)||0)))"></div>
...
function buildDimEditor(sec, idx) {
  ...
  if (type === 'bannerImage') {
    ...
    fields = [
      ...
      { key:'elementSpacing',   label:'Element Spacing (px)', type:'number', min:0, max:15, step:1, def:0 },
