...
<title><?php echo $__env->yieldContent('title', 'Admin'); ?> — Ramo Store</title>
...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="<?php echo e(route('admin.vendors')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.vendors*') ? 'active' : ''); ?>">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
      Vendors
      <?php $pendingVendors = \DB::table('vendor_users')->where('status','pending')->count(); ?>
      <?php if($pendingVendors > 0): ?><span class="nav-badge yellow"><?php echo e($pendingVendors); ?></span><?php endif; ?>
    </a>
    ...
    <a href="<?php echo e(route('admin.devices')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.devices') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('admin.coupons')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.coupons') ? 'active' : ''); ?>">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.59 13.41l-7.17 7.17a2 2 0 01-2.83 0L2 12V2h10l8.59 8.59a2 2 0 010 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/></svg>
      Coupons
    </a>
    <a href="<?php echo e(route('admin.refunds')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.refunds*') ? 'active' : ''); ?>">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6"/></svg>
      Refunds
      <?php $pendingRefunds = \DB::table('refund_requests')->where('status','pending')->count(); ?>
      <?php if($pendingRefunds > 0): ?><span class="nav-badge"><?php echo e($pendingRefunds); ?></span><?php endif; ?>
    </a>
    ...
    <a href="<?php echo e(route('admin.cbr')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.cbr') ? 'active' : ''); ?>">
      ...
      Cat & Brand Requests
      <?php $pendingCbr = \DB::table('category_brand_requests')->where('status','pending')->count(); ?>
      <?php if($pendingCbr > 0): ?><span class="nav-badge yellow"><?php echo e($pendingCbr); ?></span><?php endif; ?>
    </a>
    <div class="nav-section">Content & Analytics</div>
    <a href="<?php echo e(route('admin.timeline')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.timeline') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('admin.configs')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.configs') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('admin.auth-settings')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.auth-settings') ? 'active' : ''); ?>">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0110 0v4"/></svg>
      Auth Settings
    </a>
    <a href="<?php echo e(route('admin.shipping-settings')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.shipping-settings') ? 'active' : ''); ?>">
...
</html><?php /**PATH /home/runner/workspace/resources/views/admin/layout.blade.php ENDPATH**/ ?>