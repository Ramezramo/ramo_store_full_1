<?php $__env->startSection('title', isset($order) && $order ? 'Order #'.$order->id.' — Tracking' : 'Track Your Order'); ?>
...
<div class="page">
  ...
  <div class="track-hero">
    <div class="track-form-card">
      ...
      <form method="POST" action="<?php echo e(route('order.track.submit')); ?>" class="track-form">
        <?php echo csrf_field(); ?>
        <div class="track-fields">
          <div class="track-field">
            <label>Order Number</label>
            <input type="number" name="order_id" placeholder="e.g. 1042"
                   value="<?php echo e(old('order_id', request('order_id'))); ?>"
...
unset($__errorArgs, $__bag); ?>
      ...
      <?php if(auth()->guard()->check()): ?>
        <p class="track-alt">Or <a href="<?php echo e(route('account.orders')); ?>" class="track-link">view all your orders</a> in your account.</p>
      <?php endif; ?>
    </div>
  </div>
  ...
  <div class="order-result">
    ...
    <div class="or-footer">
      <a href="<?php echo e(route('order.track')); ?>" class="btn btn-outline" style="border-radius:10px;padding:11px 20px;font-size:13.5px">Track Another Order</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/web/order-tracking.blade.php ENDPATH**/ ?>