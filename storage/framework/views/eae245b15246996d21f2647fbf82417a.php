...
<div class="admin-wrap">
  <aside class="sidebar">
    ...
    <div class="sidebar-footer">Signed in as <?php echo e(auth()->user()->name); ?></div>
  </aside>
  <div class="main">
    <div class="topbar">
      ...
      <div style="display:flex;align-items:center;gap:16px">
        ...
        <span class="topbar-user"><?php echo e(auth()->user()->email); ?></span>
      </div>
    </div>
    ...
    <div class="content">
      ...
      <div class="stats-row">
        ...
        <div class="stat-card">
          <div class="stat-num"><?php echo e($g->cnt); ?></div>
          <div class="stat-label"><?php echo e($g->config_group); ?></div>
        </div>
      ...
      <div class="card" style="padding:16px">
        <form method="GET" action="/admin/configs" style="display:flex;gap:10px;flex-wrap:wrap;align-items:center">
          <select name="group" class="filter-select" onchange="this.form.submit()">
            <option value="all" <?php echo e($group==='all'?'selected':''); ?>>All Groups</option>
            <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($g->config_group); ?>" <?php echo e($group===$g->config_group?'selected':''); ?>><?php echo e(ucfirst($g->config_group)); ?> (<?php echo e($g->cnt); ?>)</option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select>
          <select name="lang" class="filter-select" onchange="this.form.submit()">
            <option value="all" <?php echo e($lang==='all'?'selected':''); ?>>All Languages</option>
            <option value="null" <?php echo e($lang==='null'?'selected':''); ?>>Language-Independent</option>
            <?php $__currentLoopData = $langs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php if($l->lang): ?>
              <option value="<?php echo e($l->lang); ?>" <?php echo e($lang===$l->lang?'selected':''); ?>><?php echo e(strtoupper($l->lang)); ?> (<?php echo e($l->cnt); ?>)</option>
              <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select>
          <input type="text" name="search" class="filter-search" value="<?php echo e($search); ?>" placeholder="Search key or label…">
      ...
      <div class="card" style="padding:0;overflow:hidden">
        <div style="overflow-x:auto">
          <table class="config-table">
            ...
            <tbody>
              <?php $__empty_1 = true; $__currentLoopData = $configs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cfg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <tr id="row-<?php echo e($cfg->id); ?>">
                <td><span class="key-cell"><?php echo e($cfg->config_key); ?></span></td>
                <td style="font-size:13px;color:var(--c-mid);max-width:180px"><?php echo e($cfg->label ?? '—'); ?></td>
                <td>
                  <span class="group-badge"><?php echo e($cfg->config_group); ?></span>
                  <?php if($cfg->lang): ?>
                    <span class="lang-badge lang-<?php echo e($cfg->lang); ?>"><?php echo e(strtoupper($cfg->lang)); ?></span>
                  <?php else: ?>
                    <span class="lang-badge lang-null">all langs</span>
                  <?php endif; ?>
                </td>
                <td>
                  <div class="value-preview" title="<?php echo e(e($cfg->value)); ?>"><?php echo e($cfg->value); ?></div>
                </td>
                <td style="text-align:center">
                  <span class="public-dot <?php echo e($cfg->is_public ? 'dot-green' : 'dot-gray'); ?>" title="<?php echo e($cfg->is_public ? 'Public' : 'Private'); ?>"></span>
                </td>
                <td style="text-align:right">
                  <button class="btn-sm btn-outline" style="margin-right:4px" onclick="openEdit(<?php echo e($cfg->id); ?>, <?php echo e(json_encode($cfg->config_key)); ?>, <?php echo e(json_encode($cfg->value)); ?>, <?php echo e(json_encode($cfg->label ?? '')); ?>, <?php echo e(json_encode($cfg->description ?? '')); ?>, <?php echo e($cfg->is_public ? 'true' : 'false'); ?>)">Edit</button>
                  <button class="btn-sm btn-red" onclick="deleteConfig(<?php echo e($cfg->id); ?>, '<?php echo e($cfg->config_key); ?>')">Del</button>
                </td>
              </tr>
        ...
        <div style="padding:12px 16px;border-top:1px solid var(--c-light);font-size:12px;color:var(--c-mid)">
          Showing <?php echo e($configs->count()); ?> config<?php echo e($configs->count()!=1?'s':''); ?>
      ...
      <div class="form-row-2" style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
        ...
        <div class="form-row" style="margin:0">
          ...
          <select id="new-group" class="filter-select" style="width:100%;padding:9px 12px;border:1.5px solid var(--c-light);border-radius:8px;font-size:13px;font-family:inherit">
            <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($g->config_group); ?>"><?php echo e(ucfirst($g->config_group)); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH /home/runner/workspace/resources/views/admin/configs/index.blade.php ENDPATH**/ ?>