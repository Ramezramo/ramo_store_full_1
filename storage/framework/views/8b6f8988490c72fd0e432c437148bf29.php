...
<?php if($errors->any()): ?>
  <div class="vs-alert-err">
    <ul style="margin:0 0 0 16px"><?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li><?php echo e($e); ?></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></ul>
  </div>
<?php endif; ?>

<div style="margin-bottom:14px">
  <a href="<?php echo e(route('admin.products')); ?>" style="color:var(--mid);font-size:13px">← All Products</a>
</div>
...
<?php if($vendor): ?>
  <div class="vendor-info-bar">
    ...
    <span>Sold by <strong><?php echo e($vendor->shop_name ?? ($vendor->first_name.' '.$vendor->last_name)); ?></strong></span>
    <span style="color:var(--mid)">·</span>
    <span style="color:var(--mid)"><?php echo e($vendor->email); ?></span>
    <a href="<?php echo e(route('admin.vendors.show', $vendor->id)); ?>" style="margin-left:auto;font-size:12px;color:#3b82f6;text-decoration:none;font-weight:600">View Vendor →</a>
  </div>
<?php endif; ?>
...
<div class="ph-wrap">
  <?php if($thumbUrl): ?>
    <img src="<?php echo e($thumbUrl); ?>" class="ph-thumb" alt="">
  <?php else: ?>
  ...
  <?php endif; ?>
  <div class="ph-meta">
    <div class="ph-name"><?php echo e($product->name); ?></div>
    <div class="ph-badges">
      <span class="badge badge-<?php echo e($product->status); ?>"><?php echo e(ucfirst($product->status)); ?></span>
      <span class="badge badge-<?php echo e($product->acceptance_status ?? 'pending'); ?>"><?php echo e(ucfirst($product->acceptance_status ?? 'Pending')); ?></span>
      <?php if($product->product_type): ?>
        <span class="badge badge-<?php echo e($product->product_type); ?>"><?php echo e(ucfirst($product->product_type)); ?></span>
      <?php endif; ?>
      <?php if($discountPct > 0): ?>
        <span class="badge badge-sale"><?php echo e($discountPct); ?>% OFF</span>
      <?php endif; ?>
      <?php if($product->sku): ?>
        <span style="font-size:12px;color:var(--mid);font-family:monospace">SKU: <?php echo e($product->sku); ?></span>
      <?php endif; ?>
    </div>
  </div>
  <div class="ph-actions">
    ...
    <?php endif; ?>
    <form method="POST" action="<?php echo e(route('admin.products.delete', $product->id)); ?>" onsubmit="return confirm('Permanently delete this product?')">
...
<div class="dc" id="dc-basic">
  ...
  <div class="dc-body">
    <div id="view-basic">
      <div class="dr"><span class="dr-label">Name</span><span class="dr-value"><?php echo e($product->name); ?></span></div>
      <div class="dr"><span class="dr-label">Status</span><span class="dr-value"><span class="badge badge-<?php echo e($product->status); ?>"><?php echo e(ucfirst($product->status)); ?></span></span></div>
      <div class="dr"><span class="dr-label">Acceptance</span><span class="dr-value"><span class="badge badge-<?php echo e($product->acceptance_status ?? 'pending'); ?>"><?php echo e(ucfirst($product->acceptance_status ?? 'pending')); ?></span></span></div>
      <div class="dr"><span class="dr-label">Product Type</span><span class="dr-value"><?php echo e(ucfirst($product->product_type ?? 'physical')); ?></span></div>
      <?php $buttonModeLabels = ['both'=>'Both buttons','cart_only'=>'Add to Cart only','details_only'=>'See Details only']; ?>
      <div class="dr"><span class="dr-label">Card Buttons</span><span class="dr-value"><?php echo e($buttonModeLabels[$product->button_mode ?? 'both'] ?? 'Both buttons'); ?></span></div>
      <div class="dr"><span class="dr-label">SKU</span><span class="dr-value"><?php if($product->sku): ?><span class="mono"><?php echo e($product->sku); ?></span><?php else: ?><span style="color:var(--mid)">—</span><?php endif; ?></span></div>
      <div class="dr"><span class="dr-label">Brand</span>
        <?php $brandName = $brands->firstWhere('id', $product->brand_id)?->name ?? null; ?>
        <span class="dr-value"><?php echo e($brandName ?? '—'); ?></span>
      </div>
      <div class="dr"><span class="dr-label">Unit</span><span class="dr-value"><?php echo e($unitAmount); ?> <?php echo e($unitType); ?></span></div>
      <?php if($product->short_description): ?>
        <div class="dr"><span class="dr-label">Short Desc</span><span class="dr-value"><?php echo e($product->short_description); ?></span></div>
      <?php endif; ?>
      <?php if($product->description): ?>
        <div class="dr" style="align-items:flex-start">
          <span class="dr-label">Description</span>
          <span class="dr-value" style="max-height:80px;overflow:hidden"><?php echo e(Str::limit(strip_tags($product->description), 200)); ?></span>
        </div>
      <?php endif; ?>
    </div>

    <div id="edit-basic" style="display:none">
      <form method="POST" action="<?php echo e($sectionUrl); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="if-grid" style="margin-bottom:12px">
          <div class="if-group">
            ...
            <input type="text" name="name" class="if-input" value="<?php echo e(old('name', $product->name)); ?>" required maxlength="500">
          </div>
          <div class="if-group">
            <label class="if-label">SKU</label>
            <input type="text" name="sku" class="if-input" value="<?php echo e(old('sku', $product->sku)); ?>" maxlength="100" placeholder="e.g. SHIRT-RED-M">
          </div>
        </div>
        <div class="if-grid" style="margin-bottom:12px">
          <div class="if-group">
            ...
            <select name="status" class="if-input">
              <option value="publish" <?php echo e(old('status',$product->status)==='publish' ? 'selected' : ''); ?>>Published</option>
              <option value="draft"   <?php echo e(old('status',$product->status)==='draft'   ? 'selected' : ''); ?>>Draft</option>
              <option value="private" <?php echo e(old('status',$product->status)==='private' ? 'selected' : ''); ?>>Private</option>
            </select>
          </div>
          <div class="if-group">
            <label class="if-label">Acceptance Status</label>
            <select name="acceptance_status" class="if-input">
              <option value="pending"  <?php echo e(old('acceptance_status',$product->acceptance_status)==='pending'  ? 'selected' : ''); ?>>Pending</option>
              <option value="approved" <?php echo e(old('acceptance_status',$product->acceptance_status)==='approved' ? 'selected' : ''); ?>>Approved</option>
              <option value="rejected" <?php echo e(old('acceptance_status',$product->acceptance_status)==='rejected' ? 'selected' : ''); ?>>Rejected</option>
            </select>
          </div>
        </div>
        <div class="if-grid" style="margin-bottom:12px">
          <div class="if-group">
            ...
            <select name="product_type" class="if-input">
              <option value="physical" <?php echo e(old('product_type',$product->product_type)==='physical' ? 'selected' : ''); ?>>Physical (shipped)</option>
              <option value="digital"  <?php echo e(old('product_type',$product->product_type)==='digital'  ? 'selected' : ''); ?>>Digital (download)</option>
            </select>
          </div>
          <div class="if-group">
            <label class="if-label">Card Buttons</label>
            <select name="button_mode" class="if-input">
              <option value="both"         <?php echo e(old('button_mode', $product->button_mode ?? 'both')==='both'         ? 'selected' : ''); ?>>Both "Add to Cart" &amp; "See Details"</option>
              <option value="cart_only"    <?php echo e(old('button_mode', $product->button_mode ?? 'both')==='cart_only'    ? 'selected' : ''); ?>>Add to Cart only</option>
              <option value="details_only" <?php echo e(old('button_mode', $product->button_mode ?? 'both')==='details_only' ? 'selected' : ''); ?>>See Details only</option>
            </select>
          </div>
        </div>
        <div class="if-grid" style="margin-bottom:12px">
        ...
        <div class="if-grid" style="margin-bottom:12px">
          <div class="if-group">
            ...
            <select name="unit" class="if-input">
              <?php $__currentLoopData = ['piece','kg','g','liter','ml','meter','cm','box','pack','set']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($u); ?>" <?php echo e(old('unit',$unitType)===$u ? 'selected' : ''); ?>><?php echo e($u); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
          </div>
          <div class="if-group">
            <label class="if-label">Unit Amount</label>
            <input type="number" name="unit_amount" class="if-input" step="0.01" min="0.01" value="<?php echo e(old('unit_amount',$unitAmount)); ?>">
          </div>
        </div>
        <div class="if-group">
          <label class="if-label">Short Description</label>
          <textarea name="short_description" class="if-input" style="min-height:60px;resize:vertical" maxlength="1000"><?php echo e(old('short_description',$product->short_description)); ?></textarea>
        </div>
        <div class="if-group">
          <label class="if-label">Full Description</label>
          <textarea name="description" class="if-input" style="min-height:100px;resize:vertical"><?php echo e(old('description',$product->description)); ?></textarea>
        </div>
        ...
        <div class="dr"><span class="dr-label">Price</span>
          <span class="dr-value" style="font-weight:700;font-size:15px">
            <?php if($priceRange['min'] == $priceRange['max']): ?>
              <?php echo e(number_format($priceRange['min'],2)); ?> EGP
            <?php else: ?>
              <?php echo e(number_format($priceRange['min'],2)); ?> – <?php echo e(number_format($priceRange['max'],2)); ?> EGP
            <?php endif; ?>
          </span>
        </div>
      <?php elseif($mainVar): ?>
        <div class="dr"><span class="dr-label">Regular Price</span><span class="dr-value" style="font-weight:700"><?php echo e(number_format($mainVar->regular_price,2)); ?> EGP</span></div>
        <?php if($mainVar->sale_price && $mainVar->sale_price < $mainVar->regular_price): ?>
          <div class="dr"><span class="dr-label">Sale Price</span><span class="dr-value" style="color:var(--red);font-weight:700"><?php echo e(number_format($mainVar->sale_price,2)); ?> EGP</span></div>
        <?php endif; ?>
      <?php endif; ?>
      <div class="dr"><span class="dr-label">Discount</span><span class="dr-value"><?php echo e($discountPct > 0 ? $discountPct.'%' : 'No discount'); ?></span></div>
      <div class="dr"><span class="dr-label">Total Stock</span>
        <span class="dr-value" style="font-weight:600;color:<?php echo e($totalStock > 10 ? 'var(--green)' : ($totalStock > 0 ? 'var(--yellow)' : 'var(--red)')); ?>">
          <?php echo e($totalStock); ?> units
        </span>
      </div>
      <div class="dr"><span class="dr-label">Min Order Qty</span><span class="dr-value"><?php echo e($product->minimum_order_qty ?? 1); ?></span></div>
      <div class="dr"><span class="dr-label">Max Per Person</span><span class="dr-value"><?php echo e($product->max_orders_per_person ? $product->max_orders_per_person : 'Unlimited'); ?></span></div>
    </div>
      ...
      <form method="POST" action="<?php echo e($sectionUrl); ?>">
        ...
        <div class="if-grid">
          <div class="if-group">
            ...
            <input type="number" name="discount_percentage" class="if-input" step="0.01" min="0" max="100"
                   value="<?php echo e(old('discount_percentage',$product->discount_percentage ?? 0)); ?>" placeholder="0">
          </div>
          <div class="if-group">
            <label class="if-label">Min Order Qty</label>
            <input type="number" name="minimum_order_qty" class="if-input" min="1" max="1000"
                   value="<?php echo e(old('minimum_order_qty',$product->minimum_order_qty ?? 1)); ?>">
          </div>
        </div>
        <div class="if-group" style="max-width:220px">
          ...
          <input type="number" name="max_orders_per_person" class="if-input" min="0" max="1000"
                 value="<?php echo e(old('max_orders_per_person',$product->max_orders_per_person ?? 0)); ?>">
        </div>
        <div class="if-actions">
          <button type="submit" class="dc-save-btn">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>
...
<div class="dc" id="dc-variations">
  <div class="dc-head">
    <div class="dc-title">
      ...
      <span style="font-size:11px;font-weight:400;color:var(--mid);text-transform:none;letter-spacing:0">
        <?php echo e($dbVariations->count()); ?> variation<?php echo e($dbVariations->count() !== 1 ? 's' : ''); ?>

        <?php if(count($colorGroups2) > 0): ?> · <?php echo e(count($colorGroups2)); ?> color<?php echo e(count($colorGroups2) !== 1 ? 's' : ''); ?> <?php endif; ?>
      </span>
    </div>
  ...
  <div class="dc-body">
    <div id="view-variations">
      ...
      <?php else: ?>
        <table class="var-table">
          ...
          <tbody>
            <?php $__currentLoopData = $dbVariations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php
              ...
              ?>
              <tr>
                <td><?php echo e($dvColor); ?><?php if($dv->main_variation): ?><span class="main-chip">main</span><?php endif; ?></td>
                <td><?php echo e($dvSize); ?></td>
                <td><?php echo e(number_format($dv->regular_price,2)); ?></td>
                <td style="<?php echo e($dv->sale_price && $dv->sale_price < $dv->regular_price ? 'color:var(--red);font-weight:600' : ''); ?>">
                  <?php echo e($dv->sale_price ? number_format($dv->sale_price,2) : number_format($dv->price,2)); ?>

                </td>
                <td style="color:<?php echo e($dv->stock_quantity > 10 ? 'var(--green)' : ($dv->stock_quantity > 0 ? 'var(--yellow)' : 'var(--red)')); ?>;font-weight:600">
                  <?php echo e($dv->stock_quantity); ?>
    ...
    <div id="edit-variations" style="display:none">
      <form method="POST" action="<?php echo e($sectionUrl); ?>" enctype="multipart/form-data" id="form-admin-variations">
        <?php echo csrf_field(); ?>
        ...
        <div style="margin-bottom:12px">
          <label style="display:flex;align-items:center;gap:8px;font-size:13px;font-weight:600;cursor:pointer">
            <input type="checkbox" name="has_variations" id="admin-var-toggle" value="1"
                   <?php echo e($hasVariations ? 'checked' : ''); ?> onchange="adminToggleVarPanel(this.checked)">
            This product has Color + Size variations
          </label>
        </div>
        <div id="admin-var-panel" style="<?php echo e($hasVariations ? '' : 'display:none'); ?>">
        ...
        <div id="admin-simple-panel" style="<?php echo e($hasVariations ? 'display:none' : ''); ?>">
          <div class="if-grid">
            <div class="if-group">
              ...
              <input type="number" name="regular_price" class="if-input" step="0.01" min="0"
                     value="<?php echo e($mainVar->regular_price ?? ''); ?>" placeholder="0.00">
            </div>
            <div class="if-group">
              <label class="if-label">Sale Price (EGP)</label>
              <input type="number" name="sale_price" class="if-input" step="0.01" min="0"
                     value="<?php echo e($mainVar->sale_price ?? ''); ?>" placeholder="Leave blank if none">
            </div>
            <div class="if-group">
              ...
              <input type="number" name="stock_quantity" class="if-input" min="0"
                     value="<?php echo e($mainVar->stock_quantity ?? 0); ?>" placeholder="0">
            </div>
          </div>
        </div>
        <div class="if-actions">
...
<?php if($dbVariations->isNotEmpty()): ?>
<?php $varImgCount = $dbVariations->sum(fn($v) => count($v->images ?? [])); ?>
<div class="dc" id="dc-varimages">
  <div class="dc-head">
    <div class="dc-title">
      <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
      Variation Images
      <span style="font-size:11px;font-weight:400;color:var(--mid);text-transform:none;letter-spacing:0"><?php echo e($varImgCount); ?> image<?php echo e($varImgCount !== 1 ? 's' : ''); ?></span>
    </div>
    ...
    <div id="view-varimages">
      ...
      <?php $__currentLoopData = $dbVariations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="dr" style="align-items:flex-start;margin-bottom:8px">
          <span class="dr-label" style="font-weight:600"><?php echo e($dvColor); ?><?php echo e($dvSize ? ' / '.$dvSize : ''); ?></span>
          <div class="img-grid" style="margin-top:0">
            <?php $__currentLoopData = $dvImgs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vImg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <img src="<?php echo e($imgBase . ltrim($vImg, '/')); ?>" class="img-thumb" alt="" onerror="this.style.display='none'">
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
        </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      ...
      <?php $__currentLoopData = $dbVariations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="color-row" style="margin-bottom:14px">
          <div class="color-row-header">
            <span class="color-row-badge"><?php echo e($dvLabel); ?></span>
            <?php if($dv->main_variation): ?><span style="font-size:10px;color:var(--mid);margin-left:6px">★ main</span><?php endif; ?>
          </div>
          <?php if(!empty($dvImgs)): ?>
              ...
              <div style="display:flex;flex-wrap:wrap;gap:10px;margin-top:6px">
                <?php $__currentLoopData = $dvImgs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vImg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <label style="position:relative;cursor:pointer" title="Check to delete">
                    <img src="<?php echo e($imgBase . ltrim($vImg, '/')); ?>"
                         style="width:72px;height:72px;border-radius:8px;object-fit:cover;border:2px solid var(--light);display:block"
                         onerror="this.style.opacity='.25'">
                    <input type="checkbox" name="delete_images[]" value="<?php echo e($vImg); ?>"
                           form="admin-vi-form-<?php echo e($dv->id); ?>"
          ...
          <?php endif; ?>
          <form id="admin-vi-form-<?php echo e($dv->id); ?>"
                method="POST"
                action="<?php echo e($sectionUrl); ?>"
                enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="_section"     value="var_images">
            <input type="hidden" name="variation_id" value="<?php echo e($dv->id); ?>">
            <div class="if-group">
              <label class="if-label">Add New Images</label>
              <label for="admin-vi-file-<?php echo e($dv->id); ?>" class="img-drop" style="min-height:54px">
              ...
              <input type="file" id="admin-vi-file-<?php echo e($dv->id); ?>" name="new_images[]"
...
<div class="dc" id="dc-categories">
  ...
  <div class="dc-body">
    <div id="view-categories">
      <?php $selCatNames = $categories->whereIn('id', $selectedCats)->pluck('name'); ?>
      <?php if($selCatNames->isEmpty()): ?>
        <span style="color:var(--mid);font-size:13px">No categories selected.</span>
      <?php else: ?>
        <div style="display:flex;flex-wrap:wrap;gap:6px">
          <?php $__currentLoopData = $selCatNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><span class="cat-chip"><?php echo e($cn); ?></span><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
      <?php endif; ?>
    </div>
    <div id="edit-categories" style="display:none">
      ...
      <form method="POST" action="<?php echo e($sectionUrl); ?>">
        ...
        <div class="cat-grid-check">
          <?php $__currentLoopData = $topLevel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div>
              <div style="font-size:11px;font-weight:700;color:var(--mid);text-transform:uppercase;letter-spacing:.04em;margin-bottom:4px"><?php echo e($parent->name); ?></div>
              <label class="cat-check-label">
                <input type="checkbox" name="categories[]" value="<?php echo e($parent->id); ?>"
                       <?php echo e(in_array($parent->id, $selectedCats) ? 'checked' : ''); ?>>
                <?php echo e($parent->name); ?>

              </label>
              <?php $__currentLoopData = $children->get($parent->id, collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <label class="cat-check-label" style="padding-left:14px">
                  <input type="checkbox" name="categories[]" value="<?php echo e($child->id); ?>"
                         <?php echo e(in_array($child->id, $selectedCats) ? 'checked' : ''); ?>>
...
<div class="dc" id="dc-images">
  ...
  <div class="dc-body">
    ...
    <div id="view-images">
      ...
      <?php if(!empty($images['thumbnail'])): ?>
        <div class="dr" style="align-items:flex-start;margin-bottom:12px">
          <span class="dr-label">Thumbnail</span>
          <img src="<?php echo e($imgBase . ltrim($images['thumbnail'],'/')); ?>" class="img-thumb"
               style="width:80px;height:80px" alt="" onerror="this.style.opacity='.25'">
        </div>
      <?php endif; ?>

      <?php if(!empty($allOthers)): ?>
        <div style="margin-bottom:14px">
          <div style="font-size:11px;font-weight:700;color:var(--mid);text-transform:uppercase;letter-spacing:.05em;margin-bottom:8px">
            📷 Product Images (<?php echo e(count($allOthers)); ?>)
          </div>
          <div class="img-grid">
            <?php $__currentLoopData = $allOthers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $oi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <img src="<?php echo e($imgBase . ltrim($oi,'/')); ?>" class="img-thumb" alt="" onerror="this.style.opacity='.2'">
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
        </div>
      <?php endif; ?>

      <?php if(!empty($naturals)): ?>
        <div style="margin-bottom:14px">
          <div style="font-size:11px;font-weight:700;color:var(--mid);text-transform:uppercase;letter-spacing:.05em;margin-bottom:8px">
            🌿 Natural / Lifestyle Images (<?php echo e(count($naturals)); ?>)
          </div>
          <div class="img-grid">
            <?php $__currentLoopData = $naturals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ni): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <img src="<?php echo e($imgBase . ltrim($ni,'/')); ?>" class="img-thumb" alt="" onerror="this.style.opacity='.2'">
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
        </div>
      <?php endif; ?>

      <?php if(empty($images['thumbnail']) && empty($allOthers) && empty($naturals)): ?>
    ...
    <div id="edit-images" style="display:none">
      ...
      <form method="POST" action="<?php echo e($sectionUrl); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="if-group">
          ...
          <?php if(!empty($images['thumbnail'])): ?>
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:10px">
              <div style="position:relative;width:72px;height:72px;border-radius:8px;overflow:hidden;border:1.5px solid var(--light)">
                <img src="<?php echo e($imgBase . ltrim($images['thumbnail'],'/')); ?>"
          ...
          <label for="admin-thumb" class="img-drop">
            ...
            <span id="admin-thumb-label"><?php echo e(empty($images['thumbnail']) ? 'Click to upload thumbnail' : 'Click to replace thumbnail'); ?></span>
          </label>
        ...
        <div class="if-group">
          ...
          <?php $allOthersEdit = array_merge($images['others'] ?? [], $images['other_images'] ?? []); ?>
          <?php if(!empty($allOthersEdit)): ?>
            <div class="adm-del-hint">Check images below to delete them on save:</div>
            <div class="adm-img-del-grid">
              <?php $__currentLoopData = $allOthersEdit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $oi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="adm-img-del-item">
                  <img src="<?php echo e($imgBase . ltrim($oi,'/')); ?>" alt="" onerror="this.style.opacity='.2'">
                  <input type="checkbox" name="delete_other_images[]" value="<?php echo e($oi); ?>" title="Delete this image">
                </div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
          <?php endif; ?>
        ...
        <div class="if-group">
          ...
          <?php $naturalsEdit = $images['natural'] ?? $images['natural_images'] ?? []; ?>
          <?php if(!empty($naturalsEdit)): ?>
            <div class="adm-del-hint">Check images below to delete them on save:</div>
            <div class="adm-img-del-grid">
              <?php $__currentLoopData = $naturalsEdit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ni): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="adm-img-del-item">
                  <img src="<?php echo e($imgBase . ltrim($ni,'/')); ?>" alt="" onerror="this.style.opacity='.2'">
                  <input type="checkbox" name="delete_natural_images[]" value="<?php echo e($ni); ?>" title="Delete this image">
                </div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
          <?php endif; ?>
...
<div class="dc" id="dc-attributes">
  <div class="dc-head">
    <div class="dc-title">
      ...
      Product Attributes
      <span style="font-size:11px;font-weight:400;color:var(--mid);text-transform:none;letter-spacing:0"><?php echo e(count($attributes)); ?></span>
    </div>
      ...
      <?php else: ?>
        <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="dr" style="margin-bottom:8px">
            <span class="dr-label" style="font-weight:600"><?php echo e($attr['name']); ?></span>
            <span class="dr-value">
              <?php $__currentLoopData = (array)($attr['values'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <span class="tag-pill"><?php echo e($v); ?></span>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </span>
          </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div id="edit-attributes" style="display:none">
      <form method="POST" action="<?php echo e($sectionUrl); ?>">
        ...
        <div id="admin-attr-rows">
          <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ai => $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="tr-block" id="admin-attredit-<?php echo e($ai); ?>" style="display:flex;align-items:flex-start;gap:10px;margin-bottom:8px">
              <div style="flex:1">
                <div class="if-group">
                  <label class="if-label">Attribute Name</label>
                  <input type="text" name="prod_attributes[<?php echo e($ai); ?>][name]" class="if-input"
                         value="<?php echo e($attr['name']); ?>" placeholder="e.g. Material" maxlength="100">
                </div>
                <div class="if-group">
                  <label class="if-label">Values (comma-separated)</label>
                  <input type="text" name="prod_attributes[<?php echo e($ai); ?>][values]" class="if-input"
                         value="<?php echo e(implode(', ', (array)($attr['values'] ?? []))); ?>"
...
<div class="dc" id="dc-tags">
  ...
  <div class="dc-body">
    <div id="view-tags">
      ...
      <?php else: ?>
        <div style="display:flex;flex-wrap:wrap;gap:6px">
          <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><span class="tag-pill"><?php echo e($tag); ?></span><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
      <?php endif; ?>
    </div>
...
<div class="dc" id="dc-translations">
  <div class="dc-head">
    <div class="dc-title">
      ...
      Translations
      <span style="font-size:11px;font-weight:400;color:var(--mid);text-transform:none;letter-spacing:0"><?php echo e(count($translations) + 1); ?> language<?php echo e(count($translations) + 1 !== 1 ? 's' : ''); ?></span>
    </div>
  ...
  <div class="dc-body">
    <div id="view-translations">
      <div class="tr-block">
        ...
        <?php if($product->short_description): ?>
          <div style="font-size:12px;color:var(--mid);margin-top:4px"><?php echo e(Str::limit($product->short_description, 120)); ?></div>
        <?php endif; ?>
      </div>
      <?php $__currentLoopData = $translations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php $flags = ['ar'=>'🇦🇪','fr'=>'🇫🇷','de'=>'🇩🇪','es'=>'🇪🇸','it'=>'🇮🇹']; ?>
        <div class="tr-block">
          <div class="tr-lang"><?php echo e($flags[$tr['locale']] ?? '🌐'); ?> <?php echo e(strtoupper($tr['locale'])); ?></div>
          <div style="font-weight:600;font-size:13px"><?php echo e($tr['name']); ?></div>
          <?php if(!empty($tr['description'])): ?>
            <div style="font-size:12px;color:var(--mid);margin-top:4px"><?php echo e(Str::limit($tr['description'], 120)); ?></div>
          <?php endif; ?>
        </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div id="edit-translations" style="display:none">
      <form method="POST" action="<?php echo e($sectionUrl); ?>" id="admin-form-translations">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="_section" value="translations">
        <div id="admin-tr-rows">
          <?php $__currentLoopData = $translations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $tr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="tr-block" id="admin-tredit-<?php echo e($i); ?>" style="position:relative">
              <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px">
                <span class="tr-lang"><?php echo e(strtoupper($tr['locale'])); ?></span>
              ...
              <input type="hidden" name="translations[<?php echo e($i); ?>][locale]" value="<?php echo e($tr['locale']); ?>">
              <div class="if-group">
                <label class="if-label">Name</label>
                <input type="text" name="translations[<?php echo e($i); ?>][name]" class="if-input" value="<?php echo e($tr['name']); ?>" required maxlength="500">
              </div>
              <div class="if-group">
                <label class="if-label">Description</label>
                <textarea name="translations[<?php echo e($i); ?>][description]" class="if-input" style="min-height:60px"><?php echo e($tr['description'] ?? ''); ?></textarea>
              </div>
            </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<script>
const ADMIN_EDIT_COLOR_ROWS = <?php echo json_encode($adminEditColorRows); ?>;
let adminColorIdx = 0;
let adminAttrIdx  = <?php echo e(count($attributes)); ?>;
let adminTrIdx    = <?php echo e(count($translations)); ?>;
...
document.addEventListener('DOMContentLoaded', function () {
  if (<?php echo e($hasVariations ? 'true' : 'false'); ?>) {
      ...
      <?php if($attachedCoupon): ?>
        ...
        <div style="display:inline-flex;border-radius:8px;overflow:hidden;font-size:12px;font-weight:700">
          <span style="background:#7c3aed;color:#fff;padding:7px 14px;display:flex;align-items:center;gap:6px">
            🏷️ WITH CODE <span style="background:rgba(255,255,255,.2);border-radius:4px;padding:1px 7px"><?php echo e(strtoupper($attachedCoupon->code)); ?></span>
            (<?php echo e($attachedCoupon->discount_type === 'percent' ? $attachedCoupon->amount.'%' : number_format((float)$attachedCoupon->amount,2).' EGP'); ?> off)
          </span>
          <?php if($acp > 0): ?><span style="background:#5b21b6;color:#fff;padding:7px 14px">↓ <?php echo e(number_format($acprice,2)); ?> EGP</span><?php endif; ?>
        </div>
      ...
      <form method="POST" action="<?php echo e($sectionUrl); ?>">
        ...
        <div class="if-group">
          ...
          <select name="coupon_id" class="if-input" style="background:#fff">
            ...
            <?php $__currentLoopData = $allCoupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($cp->id); ?>" <?php echo e($attachedCoupon && $attachedCoupon->id === $cp->id ? 'selected' : ''); ?>>
                <?php echo e(strtoupper($cp->code)); ?>

                — <?php echo e($cp->discount_type === 'percent' ? $cp->amount.'% off' : number_format((float)$cp->amount,2).' EGP off'); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/admin/products/show.blade.php ENDPATH**/ ?>