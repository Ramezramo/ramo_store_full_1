...
<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px">
  <div>
    ...
    <div style="font-size:13px;color:var(--mid);margin-top:2px">
      <?php echo e($products->count()); ?> product<?php echo e($products->count() === 1 ? '' : 's'); ?> in your store
  ...
  <a href="<?php echo e(route('vendor.products.create')); ?>" class="vs-btn vs-btn-primary">
...
<?php if($products->isEmpty()): ?>
  <div class="empty-state">
    ...
    <a href="<?php echo e(route('vendor.products.create')); ?>" class="vs-btn vs-btn-primary">Add Your First Product</a>
  </div>
<?php else: ?>
      ...
      <tbody>
        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <tr data-id="<?php echo e($p->id); ?>">
            <td class="chk-col">
              <input type="checkbox" class="prod-check row-check" value="<?php echo e($p->id); ?>" onchange="onRowCheck(this)">
            </td>
            <td>
              <div style="display:flex;align-items:center;gap:10px">
                <?php if($thumbUrl): ?>
                  <img src="<?php echo e($thumbUrl); ?>" class="prod-thumb" alt="">
                <?php else: ?>
                ...
                <?php endif; ?>
                <div>
                  <div style="font-weight:600;font-size:13px;max-width:220px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis"><?php echo e($p->name); ?></div>
                  <?php if($p->sku): ?><div style="font-size:11px;color:var(--mid)">SKU: <?php echo e($p->sku); ?></div><?php endif; ?>
                </div>
              </div>
            </td>
            <td>
              <div class="price-cell" data-id="<?php echo e($p->id); ?>">
                <?php if($pr): ?>
                  <div style="font-weight:700">
                    <?php if($pr->min_price == $pr->max_price): ?>
                      <?php echo e(number_format($pr->min_price, 2)); ?> EGP
                    <?php else: ?>
                      <?php echo e(number_format($pr->min_price, 2)); ?> – <?php echo e(number_format($pr->max_price, 2)); ?> EGP
                    <?php endif; ?>
                  </div>
                  <?php if($discPct > 0): ?>
                    <div class="disc-badge"><?php echo e($discPct); ?>% off</div>
                  <?php endif; ?>
                <?php else: ?>
            ...
            <td>
              <?php $qty = $pr?->total_stock ?? 0; ?>
              <?php if($qty > 10): ?>
                <span style="color:var(--green);font-weight:600"><?php echo e($qty); ?></span>
              <?php elseif($qty > 0): ?>
                <span style="color:var(--yellow);font-weight:600"><?php echo e($qty); ?></span>
              <?php else: ?>
                <span style="color:var(--red);font-weight:600">0</span>
              <?php endif; ?>
            </td>
            <td>
              <?php $vc = $pr?->var_count ?? 0; ?>
              <?php if($vc > 1): ?>
                <span style="font-size:12px;color:var(--orange);font-weight:600"><?php echo e($vc); ?> variations</span>
              <?php else: ?>
            ...
            <td><span class="badge-<?php echo e($p->acceptance_status ?? 'pending'); ?>"><?php echo e(ucfirst($p->acceptance_status ?? 'pending')); ?></span></td>
            <td style="color:var(--mid);font-size:12px;white-space:nowrap">
              <?php echo e($p->created_at ? \Carbon\Carbon::parse($p->created_at)->format('d M Y') : '—'); ?>

            </td>
            <td>
              <div style="display:flex;align-items:center;gap:14px">
                <a href="<?php echo e(route('vendor.products.show', $p->id)); ?>" class="action-link">View</a>
                <a href="<?php echo e(route('vendor.products.edit', $p->id)); ?>" class="action-link" style="color:var(--mid)">Edit All</a>
                <form method="POST" action="<?php echo e(route('vendor.products.destroy', $p->id)); ?>" onsubmit="return confirm('Delete this product? This cannot be undone.')">
...
<script>
const BULK_URL  = '<?php echo e(route("vendor.products.bulk-price")); ?>';
...
<?php echo $__env->make('web.vendor.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/web/vendor/products/index.blade.php ENDPATH**/ ?>