...
<title><?php echo $__env->yieldContent('title','Vendor Portal'); ?> — RamoStore</title>
...
<?php $vendor = auth()->guard('vendor_web')->user(); ?>
...
<aside class="vs-sidebar">
  ...
  <nav class="vs-nav">
    ...
    <a href="<?php echo e(route('vendor.dashboard')); ?>" class="vs-nav-item <?php echo e(request()->routeIs('vendor.dashboard') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('vendor.products')); ?>" class="vs-nav-item <?php echo e(request()->routeIs('vendor.products*') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('vendor.orders')); ?>" class="vs-nav-item <?php echo e(request()->routeIs('vendor.orders*') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('vendor.refunds')); ?>" class="vs-nav-item <?php echo e(request()->routeIs('vendor.refunds*') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('vendor.store', $vendor?->id)); ?>" target="_blank" class="vs-nav-item">
  ...
  <div class="vs-bottom">
    <div class="vs-vendor-info">
      <?php if($vendor?->shop_logo_url): ?>
        <img src="<?php echo e($vendor->shop_logo_url); ?>" alt="" class="vs-vendor-avatar">
      <?php else: ?>
        <div class="vs-vendor-avatar"><?php echo e(strtoupper(substr($vendor?->shop_name ?? 'V', 0, 1))); ?></div>
      <?php endif; ?>
      <div style="min-width:0">
        <div class="vs-vendor-name"><?php echo e($vendor?->shop_name); ?></div>
        <div class="vs-vendor-status"><?php echo e(ucfirst($vendor?->status ?? '')); ?></div>
      </div>
    </div>
...
<div class="vs-main">
  <div class="vs-topbar">
    <div class="vs-topbar-title"><?php echo $__env->yieldContent('page-title','Dashboard'); ?></div>
    <div>
      <a href="<?php echo e(route('home')); ?>" style="font-size:13px;color:var(--mid)">← Back to store</a>
    </div>
  </div>
  <div class="vs-content">
    <?php if(session('success')): ?>
      <div class="vs-alert vs-alert-success">✓ <?php echo e(session('success')); ?></div>
    <?php endif; ?>
    <?php if(session('error')): ?>
      <div class="vs-alert vs-alert-error">✕ <?php echo e(session('error')); ?></div>
    <?php endif; ?>
...
<?php /**PATH /home/runner/workspace/resources/views/web/vendor/layout.blade.php ENDPATH**/ ?>