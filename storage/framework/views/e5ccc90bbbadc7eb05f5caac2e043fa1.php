  ...
  <div style="max-width:520px;margin:40px auto;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,.07)">
    ...
    <div style="padding:32px">
      ...
      <p style="color:#555;font-size:15px;margin:0 0 24px;line-height:1.6">
        Hi <?php echo e($user->name ?? 'there'); ?>, thanks for signing up! Click the button below to confirm your email address and activate your account.
      </p>
      ...
      <p style="color:#bbb;font-size:11px;margin:16px 0 0">
        Or copy this URL: <a href="<?php echo e($url); ?>" style="color:#1d4ed8;word-break:break-all"><?php echo e($url); ?></a>
      </p>
    </div>
  </div>
</body>
</html>
<?php /**PATH /home/runner/workspace/resources/views/emails/verify-email.blade.php ENDPATH**/ ?>