...
<div style="display:flex;align-items:center;gap:12px;margin-bottom:20px">
  <a href="<?php echo e(route('vendor.products')); ?>" style="color:var(--mid);font-size:13px">← Back to Products</a>
  <span style="color:var(--light)">|</span>
  <div style="font-size:22px;font-weight:800"><?php echo e($isEdit ? 'Edit: '.$product->name : 'Add New Product'); ?></div>
</div>
...
?>
  <div class="vs-alert vs-alert-error" id="error-summary" style="margin-bottom:16px">
    ...
    <div style="flex:1">
      <strong><?php echo e(count($friendlyErrors)); ?> problem<?php echo e(count($friendlyErrors) !== 1 ? 's' : ''); ?> need<?php echo e(count($friendlyErrors) === 1 ? 's' : ''); ?> fixing before you can save:</strong>
      <ul style="margin:6px 0 0 16px;font-size:12px;line-height:1.7">
        <?php $__currentLoopData = $friendlyErrors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li><?php echo e($fe); ?></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </ul>
    </div>
  </div>
<?php endif; ?>
<?php $sectionErrors = $sectionErrors ?? []; ?>

<form method="POST" action="<?php echo e($formAction); ?>" enctype="multipart/form-data" id="product-form">
  <?php echo csrf_field(); ?>


<div class="section-card <?php echo e(!empty($sectionErrors['basic']) ? 'section-has-error' : ''); ?>" id="section-basic">
  <h2>
    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M11 4H4a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 013 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
    Basic Information
    <?php if(!empty($sectionErrors['basic'])): ?><span class="section-err-badge">!</span><?php endif; ?>
  </h2>
  ...
  <div class="vs-form-group">
    ...
    <input type="text" name="name"
           ...
           class="vs-input <?php echo e($errors->has('name') ? 'err' : ''); ?>"
...
unset($__errorArgs, $__bag); ?>
  ...
  <div class="vs-form-grid">
    <div class="vs-form-group">
      ...
      <select name="status" class="vs-input">
        <option value="draft"   <?php echo e(old('status', $product->status ?? 'draft') === 'draft'   ? 'selected' : ''); ?>>Draft (hidden)</option>
        <option value="publish" <?php echo e(old('status', $product->status ?? 'draft') === 'publish' ? 'selected' : ''); ?>>Published</option>
      </select>
    </div>
    <div class="vs-form-group">
      ...
      <select name="product_type" class="vs-input" id="product-type-select" onchange="toggleProductType(this.value)">
        <option value="physical" <?php echo e(old('product_type', $product->product_type ?? 'physical') === 'physical' ? 'selected' : ''); ?>>Physical (shipped)</option>
        <option value="digital"  <?php echo e(old('product_type', $product->product_type ?? 'physical') === 'digital'  ? 'selected' : ''); ?>>Digital (download)</option>
      </select>
    </div>
  </div>
  ...
  <div class="vs-form-grid">
    ...
    <div class="vs-form-group">
      ...
      <input type="number" name="unit_amount" step="0.01" min="0.01"
             value="<?php echo e(old('unit_amount', $unitAmount)); ?>"
  ...
  <div class="vs-form-group">
    ...
    <textarea name="short_description" class="vs-input" style="min-height:72px" maxlength="1000"
              placeholder="Brief summary shown on listing cards"><?php echo e(old('short_description', $product->short_description ?? '')); ?></textarea>
...
<div class="section-card <?php echo e(!empty($sectionErrors['translations']) ? 'section-has-error' : ''); ?>" id="section-translations">
  <h2>
    ...
    Translations
    <?php if(!empty($sectionErrors['translations'])): ?><span class="section-err-badge">!</span><?php endif; ?>
  ...
  <div class="lang-tab-bar" id="lang-tab-bar">
    ...
    <?php $__currentLoopData = $translations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $tr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="lang-tab" data-lang="<?php echo e($tr['locale']); ?>" onclick="switchLangTab('<?php echo e($tr['locale']); ?>')">
        <span><?php echo e(strtoupper($tr['locale'])); ?></span>
        <button type="button" class="lt-remove" onclick="removeLangTab(event,'<?php echo e($tr['locale']); ?>')">×</button>
      </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  </div>
  ...
  <div id="tr-panels-container">
    <?php $__currentLoopData = $translations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $tr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="translation-panel" id="tr-panel-<?php echo e($tr['locale']); ?>">
        <input type="hidden" name="translations[<?php echo e($i); ?>][locale]" value="<?php echo e($tr['locale']); ?>">
        <div class="vs-form-group">
          <label class="vs-label">Product Name (<?php echo e(strtoupper($tr['locale'])); ?>) <span style="color:var(--red)">*</span></label>
          <input type="text" name="translations[<?php echo e($i); ?>][name]"
                 value="<?php echo e(old("translations.$i.name", $tr['name'])); ?>"
                 class="vs-input" placeholder="Product name in <?php echo e(strtoupper($tr['locale'])); ?>" maxlength="500">
        </div>
        <div class="vs-form-group">
          <label class="vs-label">Short Description (<?php echo e(strtoupper($tr['locale'])); ?>)</label>
          <textarea name="translations[<?php echo e($i); ?>][short_description]"
                    class="vs-input" style="min-height:72px"
                    placeholder="Short description in <?php echo e(strtoupper($tr['locale'])); ?>"><?php echo e(old("translations.$i.short_description", $tr['short_description'] ?? '')); ?></textarea>
        </div>
        <div class="vs-form-group">
          <label class="vs-label">Full Description (<?php echo e(strtoupper($tr['locale'])); ?>)</label>
          <textarea name="translations[<?php echo e($i); ?>][description]"
                    class="vs-input" style="min-height:120px"
                    placeholder="Full description in <?php echo e(strtoupper($tr['locale'])); ?>"><?php echo e(old("translations.$i.description", $tr['description'])); ?></textarea>
        </div>
      </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  </div>
...
<div class="section-card <?php echo e(!empty($sectionErrors['pricing']) ? 'section-has-error' : ''); ?>" id="section-pricing">
  <h2>
    ...
    <?php if(!empty($sectionErrors['pricing'])): ?><span class="section-err-badge">!</span><?php endif; ?>
  </h2>
  ...
  <div class="vs-form-grid" style="margin-bottom:4px">
    <div class="vs-form-group">
      ...
      <input type="number" name="discount_percentage" step="0.01" min="0" max="80.99"
             ...
             class="vs-input <?php echo e($errors->has('discount_percentage') ? 'err' : ''); ?>"
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="vs-form-group">
      ...
      <input type="number" name="minimum_order_qty" min="1" max="100"
             ...
             class="vs-input <?php echo e($errors->has('minimum_order_qty') ? 'err' : ''); ?>"
             placeholder="1">
      <?php $__errorArgs = ['minimum_order_qty'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="vs-err"><?php echo e($message); ?></div><?php unset($message);
  ...
  <div class="vs-form-grid" style="margin-bottom:16px">
    <div class="vs-form-group">
      ...
      <input type="number" name="max_orders_per_person" min="0" max="100"
             ...
             class="vs-input <?php echo e($errors->has('max_orders_per_person') ? 'err' : ''); ?>"
             placeholder="0 (unlimited)">
      <?php $__errorArgs = ['max_orders_per_person'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="vs-err"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
  ...
  <label class="var-toggle-row">
    <input type="checkbox" name="has_variations" id="has-variations-toggle" value="1"
           <?php echo e(old('has_variations', $hasVariations) ? 'checked' : ''); ?>
    ...
    <div class="vs-form-grid-3">
      <div class="vs-form-group">
        ...
        <input type="number" name="regular_price" id="simple-regular-price" step="0.01" min="0"
               value="<?php echo e(old('regular_price', $variation->regular_price ?? '')); ?>"
               class="vs-input <?php echo e($errors->has('regular_price') ? 'err' : ''); ?>"
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="vs-form-group">
        ...
        <input type="number" name="sale_price" id="simple-sale-price" step="0.01" min="0"
               value="<?php echo e(old('sale_price', $variation->sale_price ?? '')); ?>"
      ...
      <div class="vs-form-group">
        ...
        <input type="number" name="stock_quantity" id="simple-stock" min="0"
               value="<?php echo e(old('stock_quantity', $variation->stock_quantity ?? 0)); ?>"
               class="vs-input <?php echo e($errors->has('stock_quantity') ? 'err' : ''); ?>"
               placeholder="0">
...
<div class="section-card <?php echo e(!empty($sectionErrors['attributes']) ? 'section-has-error' : ''); ?>" id="section-attributes">
  <h2>
    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 6h16M4 12h16M4 18h7"/></svg>
    Product Attributes
    <?php if(!empty($sectionErrors['attributes'])): ?><span class="section-err-badge">!</span><?php endif; ?>
  ...
  <div id="attr-rows">
    <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ai => $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="attr-row" id="attr-row-<?php echo e($ai); ?>">
        <div style="flex:1">
          <input type="text" name="prod_attributes[<?php echo e($ai); ?>][name]"
                 value="<?php echo e($attr['name']); ?>"
                 class="vs-input" placeholder="Attribute name (e.g. Material)" style="margin-bottom:6px">
          <input type="text" name="prod_attributes[<?php echo e($ai); ?>][values]"
...
<div class="section-card">
  ...
  <input type="hidden" name="tags_input" id="tags-hidden" value="<?php echo e(old('tags_input', implode(', ', $tags))); ?>">
  <div style="display:flex;flex-wrap:wrap;align-items:center;gap:4px;padding:8px;border:1px solid var(--light);border-radius:8px;min-height:44px" id="tags-visual">
    <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <span class="tag-pill" data-tag="<?php echo e($tag); ?>">
        <?php echo e($tag); ?>

        <button type="button" class="tag-pill-remove" onclick="removeTag('<?php echo e($tag); ?>')">×</button>
      </span>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div class="section-card">
  ...
  <div class="cat-grid">
    <?php $__currentLoopData = $topLevel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="cat-section-title"><?php echo e($parent->name); ?></div>
      <label class="cat-label">
        <input type="checkbox" name="categories[]" value="<?php echo e($parent->id); ?>"
               <?php echo e(in_array($parent->id, old('categories', $selectedCats)) ? 'checked' : ''); ?>>
      ...
      <?php $__currentLoopData = $children->get($parent->id, collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <label class="cat-label">
          <input type="checkbox" name="categories[]" value="<?php echo e($child->id); ?>"
                 <?php echo e(in_array($child->id, old('categories', $selectedCats)) ? 'checked' : ''); ?>>
    ...
    ?>
    <?php if($orphaned->count()): ?>
      <div class="cat-section-title">Other</div>
      <?php $__currentLoopData = $orphaned; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <label class="cat-label">
          <input type="checkbox" name="categories[]" value="<?php echo e($cat->id); ?>"
                 <?php echo e(in_array($cat->id, old('categories', $selectedCats)) ? 'checked' : ''); ?>>
...
<div class="section-card <?php echo e(!empty($sectionErrors['images']) ? 'section-has-error' : ''); ?>" id="section-images">
  <h2>
    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
    Product Images
    <?php if(!empty($sectionErrors['images'])): ?><span class="section-err-badge">!</span><?php endif; ?>
  </h2>
  ...
  <div class="vs-form-group">
    ...
    <?php if(!empty($images['thumbnail'])): ?>
      <div style="margin-bottom:8px">
        <img src="<?php echo e($imgBase . ltrim($images['thumbnail'],'/')); ?>" style="width:100px;height:100px;object-fit:cover;border-radius:8px;border:1px solid var(--light)">
...
unset($__errorArgs, $__bag); ?>
  ...
  <div class="vs-form-group">
    ...
    <?php if(!empty($images['other_images'])): ?>
      <div class="img-preview-row" style="margin-bottom:8px">
        <?php $__currentLoopData = $images['other_images']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $oi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="img-preview-item"><img src="<?php echo e($imgBase . ltrim($oi,'/')); ?>" alt=""></div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
  ...
  <div class="vs-form-group">
    ...
    <?php if(!empty($images['natural_images'])): ?>
      <div class="img-preview-row" style="margin-bottom:8px">
        <?php $__currentLoopData = $images['natural_images']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ni): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="img-preview-item"><img src="<?php echo e($imgBase . ltrim($ni,'/')); ?>" alt=""></div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
    <?php endif; ?>
...
<div class="section-card">
  ...
  <label class="toggle-switch" style="margin-bottom:14px">
    <input type="checkbox" name="whatsapp_available" id="wa-toggle" value="1"
           <?php echo e(old('whatsapp_available', !empty($whatsappData['available'])) ? 'checked' : ''); ?>
  ...
  <div id="wa-number-wrap" style="display:<?php echo e(old('whatsapp_available', !empty($whatsappData['available'])) ? '' : 'none'); ?>">
    <div class="vs-form-group">
      ...
      <input type="text" name="whatsapp_number"
             value="<?php echo e(old('whatsapp_number', $whatsappData['number'] ?? '')); ?>"
...
<div class="section-card">
  ...
  <input type="hidden" name="related_ids" id="related-ids-input"
         value="<?php echo e(old('related_ids', implode(',', $relatedIds))); ?>">
  ...
  <div class="rp-tags" id="rp-tags">
    <?php $__currentLoopData = $relatedProds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <span class="rp-tag" data-id="<?php echo e($rp->id); ?>">
        <?php echo e(Str::limit($rp->name, 35)); ?>

        <button type="button" onclick="removeRelated(<?php echo e($rp->id); ?>)">×</button>
      </span>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  </div>
</div>
...
<div style="display:flex;justify-content:flex-end;gap:12px;margin-bottom:40px">
  <a href="<?php echo e(route('vendor.products')); ?>" class="vs-btn vs-btn-ghost">Cancel</a>
  <button type="submit" class="vs-btn vs-btn-primary">
    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 21H5a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5v11a2 2 0 01-2 2z"/><polyline points="17 21 17 13 7 13 7 21"/><polyline points="7 3 7 8 15 8"/></svg>
    <?php echo e($isEdit ? 'Save Changes' : 'Add Product'); ?>
...
<script>
const EDIT_HAS_VARIATIONS = <?php echo e($hasVariations ? 'true' : 'false'); ?>;
const EDIT_COLOR_ROWS     = <?php echo json_encode($editColorRows); ?>;
const EDIT_PRODUCT_ID     = <?php echo e($editProductId); ?>;
const EXISTING_TRANSLATIONS = <?php echo json_encode($translations); ?>;
...
rpSearch.addEventListener('input', () => {
  ...
  searchTimeout = setTimeout(() => {
    fetch(`<?php echo e(route('vendor.products.search')); ?>?q=${encodeURIComponent(q)}&exclude=${EDIT_PRODUCT_ID||''}`)
      .then(r => r.json())
      .then(data => {
...
// ─── Product Attributes ───────────────────────────────────────────
let attrSeq = <?php echo e(count($attributes)); ?>;
function addAttrRow() {
  const idx = attrSeq++;
...
// ─── Translations ──────────────────────────────────────────────────
let trIndex = <?php echo e(count($translations)); ?>;
...
<?php echo $__env->make('web.vendor.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/web/vendor/products/create.blade.php ENDPATH**/ ?>