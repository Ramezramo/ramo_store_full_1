<?php $__env->startSection('title', 'Verify Your Email — Ramo Store'); ?>
...
<div class="page" style="max-width:460px;margin:0 auto">
  <div class="auth-card">
    ...
    <p class="auth-sub" style="text-align:center">
      ...
      <strong style="color:#1a1a1a"><?php echo e($email); ?></strong>
    </p>
    ...
    <form method="POST" action="<?php echo e(route('email.verify.resend')); ?>">
      <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/web/auth/verify-email.blade.php ENDPATH**/ ?>